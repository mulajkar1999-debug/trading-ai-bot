...
# Same level par repeated trade avoid
    ...
    try:
        ...
        for symbol in REQUESTED_SYMBOLS:
            ...
            if symbol in exchange.markets:
                ...
                print(
                    f"[SKIP] {symbol} "
                    f"not available on Bybit"
                )

        SYMBOLS = available

        print(
            "Validated Bybit symbols:",
            ", ".join(SYMBOLS)
        )
...
<div>
&gt; Bot started.
Waiting for valid Rulebook setup...
</div>
